...
public class RideNow_RG_TestCases extends CustomerApp_English_BaseClass{
	...
	@Test (dependsOnMethods= {"Launch_RideNow_ScheduleLater_DM_DuLGL_Cash"})
	public void Launch_RideNow_Burj_SorryPage() throws Exception {
		Launch_RideNow_Burj_Card_SorryPage RideNow_Burj_Sorry = new Launch_RideNow_Burj_Card_SorryPage();
		RideNow_Burj_Sorry.testOnRideNowHomescreen();
		RideNow_Burj_Sorry.testOnRideNowWheretoPage();
		RideNow_Burj_Sorry.testOnpickupPage();
		RideNow_Burj_Sorry.testOnchooseyourcarPage();
		RideNow_Burj_Sorry.testOnyChauffeur_Notes();
		RideNow_Burj_Sorry.testOnyourRidePageCard();
		RideNow_Burj_Sorry.testOnHCantFindRidePage();
		System.out.println("✅ Case 11 : RideNow Chauffeur Cancels  booking validated — Customer successfully Recieved Sorry Cant Find Ride Message.");
		Thread.sleep(50000);
