...
public class Launch_RideNow_LA_Cash extends CustomerApp_English_BaseClass{
	@BeforeClass
	...
	public void testOnWheretoPage_LA() throws InterruptedException {
		super.testOnWheretoPage_LA();
	}
	
	@Test (dependsOnMethods= {"testOnWheretoPage_LAlittle"})
	...
	public void  testOnchooseyourcarPage_LA() throws InterruptedException {
		...
		super. testOnchooseyourcarPage_LA();
	}
	
	@Test (dependsOnMethods= {" testOnchooseyourcarPage_LA"})
