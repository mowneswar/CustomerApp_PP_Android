...
public class RG_rideNow extends customerapplaunch{
	...
	@Test
	public void launch_dubaiAirportLoc_CashFlow1()  throws InterruptedException {
	...
	public void launchadRideNowSchedulater()  throws InterruptedException {
		...
		adRideNowSchedulater.testOn_okBtnScheduleLater();
		Thread.sleep(10000);
	...
	public void launchdiazabRideNowSchedulater()  throws InterruptedException {
		...
		dmZabSchLaterFlow .testOn_okBtnScheduleLater();
		Thread.sleep(10000);
