...
public class Launch_Hourly_OtherLoc_Apple extends customerapplaunch{
	@BeforeClass
	...
	public void testOnHomeScreenHourlyPickupFromPage_Du_Others() throws InterruptedException {
		super.testOnHomeScreenHourlyPickupFromPage_Du_Others();
	}
	@Test(dependsOnMethods = {"testOnHomeScreenHourlyPickupFromPage_Du_Others"})
