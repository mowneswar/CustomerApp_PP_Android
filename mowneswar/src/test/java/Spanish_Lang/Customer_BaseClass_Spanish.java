...
public class Customer_BaseClass_Spanish {
	...
	public void setUp() throws MalformedURLException, InterruptedException {
		...
		driver = new IOSDriver<MobileElement>(new URL("http://192.168.1.41:4723/"), capabilities);
	...
	public void testOnLanguagePage() throws InterruptedException {
		...
		Sequence spanishBtn = new Sequence(ProceedBtn, 1);
		spanishBtn.addAction(ProceedBtn.createPointerMove(Duration.ofMillis(0),
				PointerInput.Origin.viewport(), 37, 814));
		spanishBtn.addAction(ProceedBtn.createPointerDown(PointerInput.MouseButton.LEFT.asArg()));
		spanishBtn.addAction(new Pause(ProceedBtn, Duration.ofMillis(100)));
		spanishBtn.addAction(ProceedBtn.createPointerUp(PointerInput.MouseButton.LEFT.asArg()));

		driver.perform(Arrays.asList(spanishBtn));
		Thread.sleep(5000);
	...
	public void testOnAddressyouPage() throws InterruptedException {
		...
		MobileElement mrBtn = driver.findElementByAccessibilityId("Sr.");
		mrBtn.click();
		Thread.sleep(2000);

		MobileElement firstNameBlk = driver.findElement(MobileBy.iOSClassChain("**/XCUIElementTypeTextField[`value == \"Nombre\"`]"));
		firstNameBlk.click();
		Thread.sleep(2000);
		firstNameBlk.sendKeys("Karakudi");
		Thread.sleep(2000);


		MobileElement lastNameBlk = driver.findElement(MobileBy.iOSClassChain("**/XCUIElementTypeTextField[`value == \"Apellido\"`]"));
		lastNameBlk.click();
		Thread.sleep(2000);
		lastNameBlk.sendKeys("Pearlraja");
		Thread.sleep(2000);

		MobileElement continueBtn = driver.findElement(MobileBy.iOSClassChain("**/XCUIElementTypeOther[`name == \"CONTINUAR 󰅂\"`][3]"));
		continueBtn.click();
		Thread.sleep(2000);
	...
	public void testOnhowAddressyouPage() throws InterruptedException {
		MobileElement enteryourMailBlk = driver.findElement(MobileBy.iOSClassChain("**/XCUIElementTypeTextField[`value == \"Ingrese su correo electrónico\"`]"));
		enteryourMailBlk.click();
		Thread.sleep(2000);
		enteryourMailBlk.sendKeys("Karaikudipearl@yopmail.com");
		Thread.sleep(2000);
	...
	public void testOnAccountArwBtn() throws InterruptedException {
		...
		MobileElement profileArrwBtn = driver.findElementByXPath("//XCUIElementTypeOther[@name='Buenas tardes, Muthu Raja Singam 󰅂']");
	...
	public void testOneditProfilePageArwBtn() throws InterruptedException {
		...
		MobileElement editprofilePicArw = driver.findElementByXPath("(//XCUIElementTypeOther[@name='Muthu Raja Singam 󰅂'])[2]");
		editprofilePicArw.click();
		Thread.sleep(5000);


		MobileElement editprofilePicBtn = driver.findElementByXPath("(//XCUIElementTypeOther[@name='Agregar una foto de perfil JPEG o PNG. Máximo 5 MB.'])[1]/XCUIElementTypeOther[1]/XCUIElementTypeOther");
		editprofilePicBtn.click();
		Thread.sleep(5000);

		MobileElement takePhotoBtn = driver.findElementByAccessibilityId("Tomar foto");
		takePhotoBtn.click();
		Thread.sleep(5000);


		MobileElement editprofileBackBtn = driver.findElementByXPath("(//XCUIElementTypeOther[@name='Perfil'])[2]/XCUIElementTypeOther");
	...
	public void testOneditPhoneNumPageArwBtn() throws InterruptedException {
		...
		MobileElement editphonenumArw = driver.findElement(MobileBy.iOSClassChain("**/XCUIElementTypeOther[`name == '+971 520000959 󰅂'`][2]"));
		editphonenumArw.click();
		Thread.sleep(5000);
		MobileElement editphonenumBackBtn = driver.findElementByXPath("(//XCUIElementTypeOther[@name='Número de teléfono'])[2]/XCUIElementTypeOther");
	...
	public void testOneditEmailPageArwBtn() throws InterruptedException {
		MobileElement editEmailArw = driver.findElement(MobileBy.iOSClassChain("**/XCUIElementTypeOther[`name == \"raja@yopmail.com Clic en enlace para verificar 󰅂\"`][2]"));
		editEmailArw.click();
		Thread.sleep(5000);
		...
		MobileElement updateBtn = driver.findElementByAccessibilityId("ACTUALIZAR");
		updateBtn.click();
		Thread.sleep(8000);



		MobileElement editEmailPageBackBtn = driver.findElementByXPath("(//XCUIElementTypeOther[@name=\"Correo electrónico\"])[2]/XCUIElementTypeOther");
	...
	public void testOnPaymentsMethodsArwBtn() throws InterruptedException {
		MobileElement paymentsMethodsArwBtn = driver.findElement(MobileBy.iOSClassChain("**/XCUIElementTypeOther[`name == 'Métodos de pago 󰅂'`][2]"));
		paymentsMethodsArwBtn.click();
		Thread.sleep(5000);

		MobileElement addPaymentMethodBtn = driver.findElementByAccessibilityId("AGREGAR UN MÉTODO DE PAGO");
	...
	public void testOnprefrenceArwBtn() throws InterruptedException {
		MobileElement prefrenceArwBtn = driver.findElement(MobileBy.iOSClassChain("**/XCUIElementTypeOther[`name == \"Preferencias 󰅂\"`][2]"));
	...
	public void testOncopilotArwBtn() throws InterruptedException {
		MobileElement copilotArwBtn = driver.findElement(MobileBy.iOSClassChain("**/XCUIElementTypeOther[`name == \"Configuración del copiloto Gestione sus preferencias de viaje.\"`][2]"));
		copilotArwBtn .click();
		Thread.sleep(5000);
		...
		MobileElement bluetoothBtn = driver.findElementByAccessibilityId("Bluetooth SOLICITAR");
		bluetoothBtn.click();
		Thread.sleep(5000);


		MobileElement wifiBtn = driver.findElementByAccessibilityId("Wi-Fi SOLICITAR");
		wifiBtn.click();
		Thread.sleep(8000);

		MobileElement quiterideBtn = driver.findElementByAccessibilityId("Tranquilo DESACTIVADO");
		quiterideBtn .click();
		Thread.sleep(5000);
		...
		MobileElement applyPreferenceBtn = driver.findElement(MobileBy.iOSClassChain("**/XCUIElementTypeOther[`name == \"APLICAR PREFERENCIAS\"`][2]"));
	...
	public void testOnOthersPrefenceBtn() throws InterruptedException {
		...
		MobileElement preferencePageBackBtn = driver.findElement(MobileBy.iOSClassChain("**/XCUIElementTypeOther[`name == \"Preferencias\"`][2]/XCUIElementTypeOther"));
	...
	public void testOnSavedLocArwBtn() throws InterruptedException {
		...
		MobileElement savedLocArwBtn = driver.findElement(MobileBy.iOSClassChain("**/XCUIElementTypeOther[`name == \"Ubicaciones guardadas 󰅂\"`][2]"));
		savedLocArwBtn.click();
		Thread.sleep(5000);


		MobileElement savedLocPageBackBtn = driver.findElement(MobileBy.iOSClassChain("**/XCUIElementTypeOther[`name == \"Ubicaciones guardadas\"`][2]/XCUIElementTypeOther"));
		savedLocPageBackBtn.click();
		Thread.sleep(5000);
	}

	public void testOnLogoutArwBtn() throws InterruptedException {
		MobileElement logoutArwBtn = driver.findElement(MobileBy.iOSClassChain("**/XCUIElementTypeOther[`name == \"Cerrar sesión 󰅂\"`][2]"));
		logoutArwBtn.click();
		Thread.sleep(5000);
	...
	public void testOnMyactivityArwBtn() throws InterruptedException {
		MobileElement myActivityArwBtn = driver.findElement(MobileBy.iOSClassChain("**/XCUIElementTypeOther[`name == \"MI ACTIVIDAD 󰅂\"`][2]"));
		myActivityArwBtn.click();
		Thread.sleep(5000);

		MobileElement pastRidesBtn = driver.findElement(MobileBy.iOSClassChain("**/XCUIElementTypeOther[`name == \"VIAJES PASADOS\"`]"));
		pastRidesBtn.click();
		Thread.sleep(5000);

		MobileElement upcomingRidesBtn = driver.findElement(MobileBy.iOSClassChain("**/XCUIElementTypeOther[`name == \"PRÓXIMOS\"`]"));
		upcomingRidesBtn.click();
		Thread.sleep(5000);

		MobileElement myactivityPageBackBtn = driver.findElementByXPath("(//XCUIElementTypeOther[@name=\"Mi Actividad\"])[2]/XCUIElementTypeOther");
		myactivityPageBackBtn.click();
		Thread.sleep(5000);
	}

	public void testOnHekpCenterArwBtn() throws InterruptedException {
		MobileElement helpCenterArwBtn = driver.findElement(MobileBy.iOSClassChain("**/XCUIElementTypeOther[`name == \"CENTRO DE AYUDA 󰅂\"`][2]"));
		helpCenterArwBtn.click();
		Thread.sleep(5000);

		MobileElement needHelpArwBtn = driver.findElement(MobileBy.iOSClassChain("**/XCUIElementTypeOther[`name == \"¿Necesitas ayuda? ¿Problemas? Permítanos ayudarle.\"`][2]"));
		needHelpArwBtn.click();
		Thread.sleep(5000);

		MobileElement needHelpBackBtn = driver.findElementByXPath("(//XCUIElementTypeOther[@name=\"Centro de ayuda\"])[2]/XCUIElementTypeOther");
		needHelpBackBtn.click();
		Thread.sleep(5000);

		MobileElement termsofserviceArwBtn = driver.findElement(MobileBy.iOSClassChain("**/XCUIElementTypeOther[`name == \"Términos de servicio\"`][2]"));
		termsofserviceArwBtn.click();
		Thread.sleep(8000);

		MobileElement termsofserviceBackBtn = driver.findElementByXPath("(//XCUIElementTypeOther[@name=\"Términos de servicio\"])[2]/XCUIElementTypeOther");
		termsofserviceBackBtn.click();
		Thread.sleep(5000);

		MobileElement privacyPolicyArwBtn = driver.findElement(MobileBy.iOSClassChain("**/XCUIElementTypeOther[`name == \"Política de privacidad\"`][2]"));
		privacyPolicyArwBtn.click();
		Thread.sleep(8000);

		MobileElement privacyPolicyBackBtn = driver.findElementByXPath("(//XCUIElementTypeOther[@name=\"POLÍTICA DE PRIVACIDAD\"])[2]/XCUIElementTypeOther");
		privacyPolicyBackBtn.click();
		Thread.sleep(5000);

		MobileElement helpCenterPageBackBtn = driver.findElementByXPath("(//XCUIElementTypeOther[@name=\"Centro de ayuda\"])[2]/XCUIElementTypeOther");
	...
	public void testOnphourlySelectionPage() throws InterruptedException {
		...
		confirmBtn  .addAction( pointer77.createPointerMove(Duration.ofMillis(0),
				PointerInput.Origin.viewport(), 287, 912));
