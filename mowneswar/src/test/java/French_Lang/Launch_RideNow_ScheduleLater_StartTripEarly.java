...
public class Launch_RideNow_ScheduleLater_StartTripEarly extends  Customer_BaseClass {
	@BeforeClass
	...
	public void testOnHomeScreenHourly_DM_Pickup_Du_LglParking() throws InterruptedException {
		super.testOnHomeScreenHourly_DM_Pickup_Du_LglParking();
	}
	@Test(dependsOnMethods = {"testOnHomeScreenHourly_DM_Pickup_Du_LglParking"})
