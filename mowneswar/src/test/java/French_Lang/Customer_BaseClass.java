...
public class Customer_BaseClass {
	...
	public void setUp() throws MalformedURLException, InterruptedException {
		...
		driver = new IOSDriver<MobileElement>(new URL("http://192.168.1.13:4723/"), capabilities);
	...
	public void testOnLanguagePage() throws InterruptedException {
		...
		Sequence frenchBtn = new Sequence(ProceedBtn, 1);
		frenchBtn.addAction(ProceedBtn.createPointerMove(Duration.ofMillis(0),
				PointerInput.Origin.viewport(), 39, 885));
		frenchBtn.addAction(ProceedBtn.createPointerDown(PointerInput.MouseButton.LEFT.asArg()));
		frenchBtn.addAction(new Pause(ProceedBtn, Duration.ofMillis(100)));
		frenchBtn.addAction(ProceedBtn.createPointerUp(PointerInput.MouseButton.LEFT.asArg()));

		driver.perform(Arrays.asList(frenchBtn));
		Thread.sleep(5000);
	...
	public void testOnAddressyouPage() throws InterruptedException {
		...
		MobileElement mrBtn = driver.findElementByAccessibilityId("M.");
		mrBtn.click();
		Thread.sleep(2000);

		MobileElement firstNameBlk = driver.findElement(MobileBy.iOSClassChain("**/XCUIElementTypeTextField[`value == \"Prénom\"`]"));
		firstNameBlk.click();
		Thread.sleep(2000);
		firstNameBlk.sendKeys("Thoothukudil");
		Thread.sleep(2000);


		MobileElement lastNameBlk = driver.findElement(MobileBy.iOSClassChain("**/XCUIElementTypeTextField[`value == \"Nom\"`]"));
		lastNameBlk.click();
		Thread.sleep(2000);
		lastNameBlk.sendKeys("Pearlraja");
		Thread.sleep(2000);

		MobileElement continueBtn = driver.findElement(MobileBy.iOSClassChain("**/XCUIElementTypeOther[`name == \"CONTINUER 󰅂\"`][3]"));
		continueBtn.click();
		Thread.sleep(2000);
	...
	public void testOnhowAddressyouPage() throws InterruptedException {
		MobileElement enteryourMailBlk = driver.findElement(MobileBy.iOSClassChain("**/XCUIElementTypeTextField[`value == \"Entrez votre e-mail\"`]"));
		enteryourMailBlk.click();
		Thread.sleep(2000);
		enteryourMailBlk.sendKeys("toothukudipeayurrl@yopmail.com");
		Thread.sleep(2000);
	...
	public void testOnAccountArwBtn() throws InterruptedException {
		...
		MobileElement profileArrwBtn = driver.findElementByXPath("//XCUIElementTypeOther[@name='Bon après-midi, King MGR Khan Rama 󰅂']");
	...
	public void testOneditProfilePageArwBtn() throws InterruptedException {
		...
		MobileElement editprofilePicBtn = driver.findElementByXPath("(//XCUIElementTypeOther[@name='Modifier votre photo de profil JPEG ou PNG. Max 5 Mo.'])[1]/XCUIElementTypeOther[1]/XCUIElementTypeOther");
		editprofilePicBtn.click();
		Thread.sleep(5000);

		MobileElement takePhotoBtn = driver.findElementByAccessibilityId("Prendre une photo");
		takePhotoBtn.click();
		Thread.sleep(5000);


		MobileElement editprofileBackBtn = driver.findElementByXPath("(//XCUIElementTypeOther[@name='Profil'])[2]/XCUIElementTypeOther");
	...
	public void testOneditPhoneNumPageArwBtn() throws InterruptedException {
		...
		Thread.sleep(5000);
		MobileElement editphonenumBackBtn = driver.findElementByXPath("(//XCUIElementTypeOther[@name=\"Numéro de téléphone\"])[2]/XCUIElementTypeOther");
	...
	public void testOneditEmailPageArwBtn() throws InterruptedException {
		MobileElement editEmailArw = driver.findElement(MobileBy.iOSClassChain("**/XCUIElementTypeOther[`name == \"tutorinikingse@yopmail.com Cliquez le lien pour vérifier 󰅂\"`][2]"));
		editEmailArw.click();
		Thread.sleep(5000);
		...
		MobileElement updateBtn = driver.findElementByAccessibilityId("METTRE À JOUR");
		updateBtn.click();
		Thread.sleep(8000);



		MobileElement editEmailPageBackBtn = driver.findElementByXPath("(//XCUIElementTypeOther[@name=\"E-mail\"])[2]/XCUIElementTypeOther");
	...
	public void testOnPaymentsMethodsArwBtn() throws InterruptedException {
		MobileElement paymentsMethodsArwBtn = driver.findElement(MobileBy.iOSClassChain("**/XCUIElementTypeOther[`name == 'Modes de paiement 󰅂'`][2]"));
		paymentsMethodsArwBtn.click();
		Thread.sleep(5000);

		MobileElement addPaymentMethodBtn = driver.findElementByAccessibilityId("AJOUTER UN MODE DE PAIEMENT");
	...
	public void testOnprefrenceArwBtn() throws InterruptedException {
		MobileElement prefrenceArwBtn = driver.findElement(MobileBy.iOSClassChain("**/XCUIElementTypeOther[`name == \"Préférences 󰅂\"`][2]"));
	...
	public void testOncopilotArwBtn() throws InterruptedException {
		MobileElement copilotArwBtn = driver.findElement(MobileBy.iOSClassChain("**/XCUIElementTypeOther[`name == \"Paramètres du co-pilote Gérez vos préférences de trajet.\"`][2]"));
		copilotArwBtn .click();
		Thread.sleep(5000);
		...
		MobileElement bluetoothBtn = driver.findElementByAccessibilityId("Bluetooth DEMANDER");
		bluetoothBtn.click();
		Thread.sleep(5000);


		MobileElement wifiBtn = driver.findElementByAccessibilityId("Wi-Fi DEMANDER");
		wifiBtn.click();
		Thread.sleep(8000);

		MobileElement quiterideBtn = driver.findElementByAccessibilityId("Silencieux DÉSACTIVÉ");
		quiterideBtn .click();
		Thread.sleep(5000);
		...
		MobileElement applyPreferenceBtn = driver.findElement(MobileBy.iOSClassChain("**/XCUIElementTypeOther[`name == \"APPLIQUER LES PRÉFÉRENCES\"`][2]"));
		applyPreferenceBtn.click();
		Thread.sleep(5000);

		MobileElement applyPreferenceokBtn = driver.findElementByAccessibilityId("D'ACCORD");
	...
	public void testOnOthersPrefenceBtn() throws InterruptedException {
		...
		MobileElement preferencePageBackBtn = driver.findElement(MobileBy.iOSClassChain("**/XCUIElementTypeOther[`name == \"Préférences\"`][2]/XCUIElementTypeOther"));
	...
	public void testOnSavedLocArwBtn() throws InterruptedException {
		...
		MobileElement savedLocArwBtn = driver.findElement(MobileBy.iOSClassChain("**/XCUIElementTypeOther[`name == \"Lieux enregistrés 󰅂\"`][2]"));
		savedLocArwBtn.click();
		Thread.sleep(5000);


		MobileElement savedLocPageBackBtn = driver.findElement(MobileBy.iOSClassChain("**/XCUIElementTypeOther[`name == \"Lieux enregistrés\"`][2]/XCUIElementTypeOther"));
		savedLocPageBackBtn.click();
		Thread.sleep(5000);
	}

	public void testOnLogoutArwBtn() throws InterruptedException {
		MobileElement logoutArwBtn = driver.findElement(MobileBy.iOSClassChain("**/XCUIElementTypeOther[`name == \"Déconnexion 󰅂\"`][2]"));
		logoutArwBtn.click();
		Thread.sleep(5000);
	...
	public void testOnMyactivityArwBtn() throws InterruptedException {
		MobileElement myActivityArwBtn = driver.findElement(MobileBy.iOSClassChain("**/XCUIElementTypeOther[`name == \"MON ACTIVITÉ 󰅂\"`][2]"));
		myActivityArwBtn.click();
		Thread.sleep(5000);

		MobileElement pastRidesBtn = driver.findElement(MobileBy.iOSClassChain("**/XCUIElementTypeOther[`name == \"TRAJETS PASSÉS\"`]"));
		pastRidesBtn.click();
		Thread.sleep(5000);

		MobileElement upcomingRidesBtn = driver.findElement(MobileBy.iOSClassChain("**/XCUIElementTypeOther[`name == \"À VENIR\"`]"));
		upcomingRidesBtn.click();
		Thread.sleep(5000);

		MobileElement myactivityPageBackBtn = driver.findElementByXPath("(//XCUIElementTypeOther[@name=\"Mon Activité\"])[2]/XCUIElementTypeOther");
		myactivityPageBackBtn.click();
		Thread.sleep(5000);
	}

	public void testOnHekpCenterArwBtn() throws InterruptedException {
		MobileElement helpCenterArwBtn = driver.findElement(MobileBy.iOSClassChain("**/XCUIElementTypeOther[`name == \"CENTRE D'AIDE 󰅂\"`][2]"));
		helpCenterArwBtn.click();
		Thread.sleep(5000);

		MobileElement needHelpArwBtn = driver.findElement(MobileBy.iOSClassChain("**/XCUIElementTypeOther[`name == \"Besoin d'aide ? Un problème ? On peut vous aider\"`][2]"));
		needHelpArwBtn.click();
		Thread.sleep(5000);

		MobileElement needHelpBackBtn = driver.findElementByXPath("(//XCUIElementTypeOther[@name=\"Centre d'aide\"])[2]/XCUIElementTypeOther");
		needHelpBackBtn.click();
		Thread.sleep(5000);

		MobileElement termsofserviceArwBtn = driver.findElement(MobileBy.iOSClassChain("**/XCUIElementTypeOther[`name == \"Conditions d'utilisation\"`][2]"));
		termsofserviceArwBtn.click();
		Thread.sleep(8000);

		MobileElement termsofserviceBackBtn = driver.findElementByXPath("(//XCUIElementTypeOther[@name=\"Conditions d'utilisation\"])[2]/XCUIElementTypeOther");
		termsofserviceBackBtn.click();
		Thread.sleep(5000);

		MobileElement privacyPolicyArwBtn = driver.findElement(MobileBy.iOSClassChain("**/XCUIElementTypeOther[`name == \"Politique de confidentialité\"`][2]"));
		privacyPolicyArwBtn.click();
		Thread.sleep(8000);

		MobileElement privacyPolicyBackBtn = driver.findElementByXPath("(//XCUIElementTypeOther[@name=\"POLITIQUE DE CONFIDENTIALITÉ\"])[2]/XCUIElementTypeOther");
		privacyPolicyBackBtn.click();
		Thread.sleep(5000);

		MobileElement helpCenterPageBackBtn = driver.findElementByXPath("(//XCUIElementTypeOther[@name=\"Centre d'aide\"])[2]/XCUIElementTypeOther");
