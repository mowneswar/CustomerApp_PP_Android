...
public class Launch_Hourly_ScheduleLater extends Customer_BaseClass_Spanish{
	@BeforeClass
	...
	public void testOnHomeScreenHourlyPickupFromPage_NY() throws InterruptedException {
		super.testOnHomeScreenHourlyPickupFromPage_NY();
	}
	@Test(dependsOnMethods = {"testOnHomeScreenHourlyPickupFromPage_NY"})
