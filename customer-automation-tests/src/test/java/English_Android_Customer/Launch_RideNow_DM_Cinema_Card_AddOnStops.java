...
public class Launch_RideNow_DM_Cinema_Card_AddOnStops extends CustomerApp_English_BaseClass{
	@BeforeClass
	...
	public void testOnDubaiMall_Cin_P3() throws InterruptedException {
		super.testOnDubaiMall_Cin_P3();
	}
	@Test (dependsOnMethods= {"testOnDubaiMall_Cin_P3"})
	...
	public void testOnRideNowAddOnStops() throws InterruptedException {
		super.testOnRideNowAddOnStops();
	}
	@Test (dependsOnMethods= {"testOnRideNowAddOnStops"})
